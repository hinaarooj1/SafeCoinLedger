...
const Home = () => {
  ...
  const faqData = [
    {
      id: 1,
      question: "What is Safe Coin Ledger Wallet?",
      answer:
        "Safe Coin Ledger Wallet is a secure, easy-to-use platform for managing, sending, and receiving cryptocurrencies. It supports multiple tokens and offers advanced security features to protect your digital assets.",
    },
    {
      id: 2,
    ...
    {
      id: 3,
      question: "Is my crypto safe in Safe Coin Ledger Wallet?",
      answer:
    ...
    },
    {
      ...
      answer:
        "Safe Coin Ledger Wallet supports a wide variety of cryptocurrencies, including Bitcoin, Ethereum, and many popular altcoins. Check our supported tokens list for the full range of assets you can store and manage.",
    },
    {
      id: 5,
      question: "Can I stake my crypto in Safe Coin Ledger Wallet?",
      answer:
        "Yes, Safe Coin Ledger Wallet offers a simple staking option that allows you to earn rewards by staking your tokens directly within the app. Just choose your desired crypto, and start staking to maximize your returns.",
    },
    {
      id: 6,
      question: "Can I connect my bank account or credit card to Safe Coin Ledger Wallet?",
      answer:
        "Yes, Safe Coin Ledger Wallet allows you to link your bank account or credit card for easy purchasing and transferring of cryptocurrencies. Enjoy a simple, secure way to fund your wallet and manage your assets.",
    },
  ];
            ...
            <div className="footer-inner container-xl" >
                    ...
                    <div className="widget widget_text" >
                      <div className="widget-content" >
                        ...
                        <div className="textwidget" >
                          ...
                          <p><a href="mailto:support@safecoinledger.com" >support@safecoinledger.com</a></p>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="footer-bottom" >
                <div className="footer-credits" >
                  <p className="footer-copyright">Copyright ©2025 Safe Coin Ledger. All rights reserved.
                  </p>{/* .footer-copyright */}
                </div>{/* .footer-credits */}
